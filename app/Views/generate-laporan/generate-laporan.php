                  ...
                  <div class="nav-tabs-navigation">
                     <div class="row">
                        <div class="col">
                           ...
                           <p class="card-category">Laporan Buku</p>
                        </div>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        <div class="card h-100">
                           <form action="<?= base_url('admin/laporan/buku'); ?>" method="post" class="card-body d-flex flex-column">
                              <h4 class="text-primary"><b>Laporan Buku</b></h4>
                              <p>Total jumlah buku : <b><?= count($books) ?></b></p>
                              <p>Total Judul Buku : <b><?= $totalBookStock; ?></b></p>
