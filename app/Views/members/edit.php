  ...
  <div class="card-body">
    ...
    <form action="<?= base_url('admin/members/' . $member['uid']); ?>" method="post">
      ...
      <div class="row">
          ...
          <input type="text" class="form-control <?php if ($validation->hasError('nis')) : ?>is-invalid<?php endif ?>" id="nis" name="nis" value="<?= $oldInput['nis'] ?? $member['nis'] ??''; ?>" placeholder="Nomor induk siswa..." required>
          <div class="invalid-feedback">
