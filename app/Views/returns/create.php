      ...
      <div class="row">
        <div class="col-12 col-md-6 mb-3">
          <div class="row">
            ...
            <div class="col-12 mb-3">
              <label for="member_nis" class="form-label">Email</label>
              <input type="text" class="form-control" id="member_nis" name="member_nis" value="<?= $loan['nis']; ?>" disabled>
            </div>
            <div class="col-12 mb-3">
              <label for="member_kelas" class="form-label">Nomor telepon</label>
              <input type="text" class="form-control" id="member_kelas" name="member_kelas" value="<?= $loan['kelas']; ?>" disabled>
            </div>
            <!-- <div class="col-12 mb-3">
