...
<div class="px-4 pt-5 my-5 text-center border-bottom">
  <h1 class="display-4 fw-bold text-body-emphasis">Aplikasi<span class="text-primary">Perpustakaan SMPN 11 Sukabumi</span></h1>
  <div class="col-lg-6 mx-auto">
    <p class="lead mb-4">Temukan buku-buku menarik untuk memperluas pengetahuan dan imajinasi Anda. Aplikasi Perpustakaan adalah teman setia pencinta buku dan pembelajar di mana saja, kapan saja.</p>
