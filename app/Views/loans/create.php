  ...
  <div class="card">
    <div class="card-body">
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-6 mb-3">
          <label for="member_nis" class="form-label">Nomor Induk Siswa</label>
          <input type="text" class="form-control" id="member_nis" name="member_nis" value="<?= "{$member['nis']}"; ?>" disabled>
        </div>
        <div class="col-12 col-md-6 mb-3">
          <label for="member_kelas" class="form-label">Kelas</label>
          <input type="text" class="form-control" id="member_kelas" name="member_kelas" value="<?= "{$member['kelas']}"; ?>" disabled>
        </div>
        <!-- <div class="col-12 col-md-6 mb-3">
